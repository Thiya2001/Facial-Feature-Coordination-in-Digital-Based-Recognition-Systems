...
#title
root.title("FACIAL RECOGNITION CRIME DETECTION")
...
def getPage1():
    ...
    basicPageSetup(1)
    heading.configure(text="Register Person",font="Arial 30 bold",fg="#9C27B0" )
    right_frame.configure(text="Enter Person Details",fg="#9C27B0")
    ...
    tk.Button(scroll_frame, text="Register Person", command=lambda: register(entries, required, menu_var), font="Arial 15 bold",
...
def getPage3():
    ...
    right_frame.configure(text="Detected Person", fg="#9C27B0")
...
######################################## Home Page ####################################
tk.Label(pages[0], text="FACIAL RECOGNITION CRIME DETECTION", fg="#9C27B0", bg="black",
...
tk.Button(btn_frame, text="Scan Person", command=getPage2)
